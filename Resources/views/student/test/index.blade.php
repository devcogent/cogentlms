            ...
            @php foreach($paginator as $row):  @endphp
                <tr>
                    ...
                    if(!empty($totalClasses)){
                     ...
                     @endphp
                       @if((!$studentTest->hasTest($row->test_id,$id) || !empty($row->allow_multiple))  &&($percentage == 100) && ($courseTypeID['courseType'] == "c") && ($courseTypeID['opening_date'] <= \Carbon\Carbon::now()) && ($courseTypeID['closing_date'] >= \Carbon\Carbon::now()))
