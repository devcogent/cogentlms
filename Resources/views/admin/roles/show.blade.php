                                    ...
                                    <ul class="list-group">
                                        ...
                                        @endif
                                            ...
                                            @if($permission->name == 'view_students')
                                              <li class="list-group-item">  {{ __('View Trainee') }}</li>
                                            @elseif($permission->name =='add_student')
                                              <li class="list-group-item">  {{ __('Add Trainee') }}</li>
                                            @elseif($permission->name =='edit_student')
                                              <li class="list-group-item">   {{ __('Edit Trainee') }}</li>
                                            @elseif($permission->name =='delete_student')
                                              <li class="list-group-item">{{ __('Delete Trainee') }}</li>
                                            @elseif($permission->name =='view_student')
                                              <li class="list-group-item"> {{ __('View Trainees') }}</li>
                                            @elseif($permission->name =='export_student')
                                              <li class="list-group-item"> {{ __('Export Trainees') }}</li>
                                            @else
