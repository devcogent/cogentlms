        ...
        $opts = array(
            ...
            'roots' => array(
                array(
                    ...
                    'uploadAllow' => array(
                        'image', 'application/pdf', 'application/zip', 'application/x-compressed', 'application/x-zip-compressed', 'text/plain', 'audio/mpeg3', 'video/mpeg', 'application/x-troff-msvideo', 'video/msvideo', 'application/excel', 'application/vnd.ms-excel', 'application/x-msexcel', 'video/mp4',
