                            ...
                            <table class="table">
                                ...
                                <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" action="<?php echo e(url('/admin/delete' . '/' . $item->id)); ?>" accept-charset="UTF-8" class="int_inlinedisp" id="form<?php echo e($item->id); ?>">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lms\Resources\views/admin/admins/index.blade.php ENDPATH**/ ?>