    ...
    <div class="col-md-8">
        <div class="card course-info profile-widget mt-0">
            <div class="profile-widget-header">
                <div class="profile-widget-items">
                    ...
                    <div class="profile-widget-item">
                        ...
                        <div class="profile-widget-item-value"><?php $countClass = $totalClasses != 0 ? $totalClasses : \App\Course::find($id)->lessons()->count() ?> <?php echo e($countClass); ?></div>
                    </div>
                    <div class="profile-widget-item">
            ...
            <div class="card-footer text-center">
                    ...
                    <a  class="btn btn-primary mb-2  btn-lg" href="<?php echo e(route('student.course.intro', ['id'=>$id])); ?>"><?php echo e(__('Go To - Class Lecture')); ?></a>
...
<div class="row">
    <div class="col-md-8">
        <ul class="nav nav-pills" id="myTab3" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#home3" role="tab" aria-controls="home" aria-selected="true"><i class="fa fa-info-circle"></i> <?php echo e(__lang('Course Details')); ?></a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content" id="myTabContent2">
            ...
            <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                ...
                <?php  $sessionVenue= $row->venue; $i=0; ?>
                ...
                <?php $__currentLoopData = $rowset; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <?php $i++; ?>
                <div class="card">
                    <div class="card-header"><h4><?php echo e($i); ?>&sdot;&nbsp;<?php echo e($row2->name); ?></h4>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(date('Y-m-d',strtotime($testRow->opening_date)) > date('Y-m-d')): ?>
                                <span class="btn btn-success disabled"><?php echo e(__('Link will Open on this')); ?>&nbsp; <?php echo e(date('Y-m-d',strtotime($testRow->opening_date))); ?></span>
                                <?php endif; ?>
                                <?php if( !$studentTest->hasTest($testRow->test_id,$studentId) && date('Y-m-d',strtotime($testRow->opening_date)) < date('Y-m-d')): ?>
                                <span class="btn btn-danger disabled"><?php echo e(__('Link expired on')); ?>&nbsp; <?php echo e(date('Y-m-d',strtotime($testRow->opening_date))); ?></span>
                                <?php endif; ?>
                                <?php if($attendance < 100): ?>
                                <span class="btn btn-warning disabled"><?php echo e(__('Class Lecture not be Completed')); ?></span>
                                <?php endif; ?>
                                <?php if( (!$studentTest->hasTest($testRow->test_id,$studentId) || !empty($testRow->allow_multiple))  && (date('Y-m-d',strtotime($testRow->opening_date)) == date('Y-m-d') && date('Y-m-d',strtotime($testRow->closing_date) >= date('Y-m-d'))) &&($attendance == 100)): ?>
                                ...
                                <?php if(($studentTest->hasTest($testRow->test_id,$studentId)) && (empty($testRow->allow_multiple))): ?>
                                    <a  href="javaScript::void(0)" class="btn btn-danger disabled" ><?php echo e(__('already-taken')); ?></a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php  endif;  ?>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lms\Resources\views/student/catalog/course.blade.php ENDPATH**/ ?>