...
<?php echo $__env->make('admin.partials.crumb',[
    'crumbs'=>[
            ...
            route('admin.student.index')=>__('Trainee'),
            '#'=>'Edit-Trainee'
...
<div >
    <div class="card">
        <div class="card-header">
             <?php echo e(__('Edit-Trainee')); ?> &nbsp;  <strong><?php echo e($row->user->name); ?> <?php echo e($row->user->last_name); ?></strong>
        </div>
        <div class="card-body">

              <ul class="nav nav-pills" id="myTab3" role="tablist">
                                    <li class="nav-item">
                                      <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#home3" role="tab" aria-controls="home" aria-selected="true"><?php echo e(__('Trainee-Details')); ?></a>
                                    </li>
                                    <li class="nav-item">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lms\Resources\views/admin/student/edit.blade.php ENDPATH**/ ?>