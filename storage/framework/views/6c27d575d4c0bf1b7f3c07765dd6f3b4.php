            ...
            <?php foreach($paginator as $row):  ?>
                <tr>
                    ...
                    if(!empty($totalClasses)){
                     ...
                     ?>
                       <?php if((!$studentTest->hasTest($row->test_id,$id) || !empty($row->allow_multiple))  &&($percentage == 100) && ($courseTypeID['courseType'] == "c") && ($courseTypeID['opening_date'] <= \Carbon\Carbon::now()) && ($courseTypeID['closing_date'] >= \Carbon\Carbon::now())): ?>
                        <a href="<?php echo e(route('student.test.taketest',array('id'=>$row->test_id))); ?>" class="btn btn-primary " >
                            <i class="fa fa-play"></i> <?php echo e(__lang('Take Test')); ?>

                        </a> 
                        <?php else: ?>
                        <button class="btn btn-danger">Test Open Link Expired</button>
                        <?php endif; ?>
                        
                        <?php if((!$studentTest->hasTest($row->test_id,$id) || !empty($row->allow_multiple))  &&($percentage < 100) && ($courseTypeID['courseType'] == "c")): ?>
                        ...
                        <?php endif; ?>
                            ...
                            <?php if($studentTest->hasTest($row->test_id,$id) && $row->show_result==1): ?>
                                    <a href="<?php echo e(route('student.test.testresults',array( 'id'=>$row->test_id))); ?>" class="btn btn-success " ><i class="fa fa-list-ul"></i> <?php echo e(__lang('Your Results')); ?>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lms\Resources\views/student/test/index.blade.php ENDPATH**/ ?>