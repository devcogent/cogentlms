    ...
    <div class="main-wrapper main-wrapper-1" id="content">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                <li ><a href="<?php echo e(route('student.course-details',['id'=>$course->id,'slug'=>safeUrl($course->name)])); ?>"  class="nav-link   nav-link-lg "  ><i class="fas fa-home"></i></a></li>
            </ul>
        </nav>
                    ...
                    <?php $__currentLoopData = $course->lessons()->orderBy('pivot_sort_order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="dropdown"  >
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php 
                                $attendanceRow = $sessionLogTable->getAttendance($studentId,$sessionId,$classLecture->id);
                                $attendance =  !empty($attendanceRow) ? $attendanceRow->created_at : '';
                                ?> 
                                <?php if($attendance!= ''): ?>
                                <li data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo e($classLecture->title); ?>" >
                                   <a class="nav-link <?php if($lecture->id == $classLecture->id): ?> selected-item active <?php endif; ?>" href="<?php echo e(route(MODULE.'.course.lecture',['lecture'=>$classLecture->id,'course'=>$course->id])); ?>"><i class="fa fa-unlock" aria-hidden="true"></i> <?php echo e(limitLength($classLecture->title,20)); ?></a></li>
                                <?php else: ?>
                                <li data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo e($classLecture->title); ?>" >
                                   <a class="nav-link" href="javaScript::void(0)"> <i class="fa fa-lock" aria-hidden="true"></i><?php echo e(limitLength($classLecture->title,20)); ?></a></li>
                                <?php endif; ?>
...
<?php /**PATH C:\wamp64\www\lms\Resources\views/student/course/lecture.blade.php ENDPATH**/ ?>