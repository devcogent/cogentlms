...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://cogentems.in/erpm/Style/img/favicon.png">
    <!-- General CSS Files -->
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('client/themes/admin/assets/modules/weather-icon/css/weather-icons.min.css')); ?>">
    <link rel="stylesheet"
        href="<?php echo e(asset('client/themes/admin/assets/modules/weather-icon/css/weather-icons-wind.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('client/themes/admin/assets/modules/summernote/summernote-bs4.css')); ?>">
    <link type="text/css" rel="stylesheet"
        href="<?php echo e(asset('client/vendor/jquery-ui/css/ui-lightness/jquery-ui-1.10.4.css')); ?>" />
        ...
        <div class="main-wrapper main-wrapper-1" id="content">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <?php if(!empty(Auth::user()->picture) && file_exists(Auth::user()->picture)): ?>
                                <img alt="image" src="<?php echo e(asset(Auth::user()->picture)); ?>"
                                    class="rounded-circle mr-1">
                            <?php else: ?>
                                <img alt="image"
                                    src="<?php echo e(asset('client/themes/admin/assets/img/avatar/avatar-1.png')); ?>"
                                    class="rounded-circle mr-1">
                            <?php endif; ?>
                            <div class="d-sm-none d-lg-inline-block"><?php echo app('translator')->get('default.hi'); ?>, <?php echo e(Auth()->user()->name); ?>
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?php echo e(url('/')); ?>">
                            ...
                            <img style="width: 60%;" src="https://cogentems.in/erpm/Style/images/Cogent.png"
                    ...
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?php echo e(url('/')); ?>">
                            <img style="width: 60%;" src="https://cogentems.in/erpm/Style/img/favicon.png"
                                class="img-responsive">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="<?php echo route('admin.dashboard'); ?>" class="nav-link"><i
                                    class="fas fa-fire"></i><span><?php echo app('translator')->get('default.dashboard'); ?></span></a></li>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-group', 'course')): ?>
                            <li class="dropdown">
                                <a href="#" class="nav-link has-dropdown"><i
                                        class="fas fa-book"></i><span><?php echo e(__lang('courses-sessions')); ?></span></a>
                                <ul class="dropdown-menu">

                                    <li class="dropdown">
                                        <a href="#"
                                            class="nav-link has-dropdown"><span><?php echo e(__lang('add-new')); ?></span></a>
                                        <ul class="dropdown-menu">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'add_course')): ?>
                                                <li><a class="nav-link"
                                                        href="<?php echo route('admin.session.addcourse'); ?>"><?php echo e(__lang('online-course')); ?></a></li>
                                            <?php endif; ?>
                                    ...
                                    <li><a class="nav-link"
                                            href="<?php echo e(route('admin.student.sessions')); ?>"><?php echo e(__lang('all-courses-session')); ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-group', 'student')): ?>
                            <li class="dropdown">
                                <a href="#" class="nav-link has-dropdown"><i
                                        class="fas fa-users"></i><span><?= __('Trainee') ?></span></a>
                                <ul class="dropdown-menu">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'add_student')): ?>
                                        <li><a class="nav-link" href="<?php echo route('admin.student.add'); ?>"><?php echo e(__('Add-Trainee')); ?></a></li>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'view_students')): ?>
                                        <li><a class="nav-link" href="<?php echo route('admin.student.index'); ?>"><?php echo e(__('All-Trainee')); ?></a></li>
                                    <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-group', 'classes')): ?>
                            <li class="dropdown">
                                <a href="#" class="nav-link has-dropdown"><i
                                        class="fas fa-chalkboard-teacher "></i><span><?php echo e(__lang('classes')); ?></span></a>
                                <ul class="dropdown-menu">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'add_class')): ?>
                                        <li><a class="nav-link" href="<?php echo route('admin.lesson.add'); ?>"><?php echo e(__lang('add-class')); ?></a></li>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'view_classes')): ?>
                                        <li><a class="nav-link" href="<?php echo route('admin.lesson.index'); ?>"><?php echo e(__lang('all-classes')); ?></a>
                                        </li>
                                    <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-group', 'tests')): ?>
                            <li class="dropdown">
                                <a href="#" class="nav-link has-dropdown"><i
                                        class="fas fa-check-circle"></i><span><?php echo e(__lang('tests')); ?></span></a>
                                <ul class="dropdown-menu">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'view_tests')): ?>
                                        <li><a class="nav-link" href="<?php echo route('admin.test.add'); ?>"><?php echo e(__lang('add-test')); ?></a></li>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'add_test')): ?>
                                        <li><a class="nav-link" href="<?php echo route('admin.test.index'); ?>"><?php echo e(__lang('all-tests')); ?></a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access-group', 'settings')): ?>
                            <li class="dropdown">
                                <a href="#" class="nav-link has-dropdown"><i
                                        class="fas fa-cogs"></i><span><?php echo e(__lang('settings')); ?></span></a>
                                <ul class="dropdown-menu">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'edit_site_settings')): ?>
                                        <li><a class="nav-link" href="<?php echo route('admin.setting.index'); ?>"><?php echo e(__lang('site-settings')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'view_roles')): ?>
                                        <li><a class="nav-link" href="<?php echo route('admin.roles.index'); ?>"><?php echo e(__lang('roles')); ?></a></li>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'view_admins')): ?>
                                        <li><a class="nav-link"
                                                href="<?php echo route('admin.admins.index'); ?>"><?php echo e(__('Administrators/Trainer')); ?></a></li>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', 'view_test_grades')): ?>
                                        <li><a class="nav-link" href="<?php echo route('admin.setting.testgrades'); ?>"><?php echo e(__lang('grades')); ?></a></li>
                                    <?php endif; ?>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    <?php echo e(__lang('copyright')); ?> &copy; <?php echo e(date('Y')); ?> <a
                        href="<?php echo e(config('app.author_url')); ?>"><?php echo e(config('app.app_author')); ?></a>
                </div>
...
<?php /**PATH C:\wamp64\www\lms\Resources\views/layouts/admin.blade.php ENDPATH**/ ?>