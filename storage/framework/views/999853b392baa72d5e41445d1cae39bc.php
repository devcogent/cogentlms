                                            ...
                                            <div class="card-body_">
                                                ...
                                                <form method="post" action="<?php echo e(adminUrl(array('controller'=>'lesson','action'=>'add')).'?sessionId='.$session->id.'&back=true'); ?>">
                                                    ...
                                                    <div class="form-footer">
                                                        <button type="submit" class="btn btn-primary float-right"><?php echo e(__('Save Class')); ?></button>
                                                    </div>
                                                </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lms\Resources\views/admin/session/courseclasses.blade.php ENDPATH**/ ?>