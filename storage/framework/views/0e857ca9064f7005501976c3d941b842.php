    ...
    <div id="app">
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <a href="<?php echo e(url('/')); ?>" class="navbar-brand sidebar-gone-hide"><img style="width: 10%;"
                        src="https://cogentems.in/erpm/Style/images/Cogent.png" class="img-responsive"></a>
                ...
                <ul class="navbar-nav navbar-right">
                    <?php if(getCart()->hasItems()): ?>
                        <li>
                            <a href="<?php echo e(route('cart')); ?>" class="nav-link nav-link-lg  beep"><i
                                    class="fa fa-cart-plus"></i> <?php echo e(getCart()->getTotalItems()); ?></a>
                        </li>
                    <?php endif; ?>
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <?php if(!empty(Auth::user()->picture) && file_exists(Auth::user()->picture)): ?>
                                <img alt="image" src="<?php echo e(resizeImage(Auth::user()->picture, 50, 50, url('/'))); ?>"
                            ...
                            <?php else: ?>
                                <img alt="image"
                                    ...
                                    class="rounded-circle mr-1">
                            <?php endif; ?>
                            <div class="d-sm-none d-lg-inline-block"><?php echo app('translator')->get('default.hi'); ?>,
                                <?php echo e(limitLength(Auth()->user()->name, 30)); ?></div>
                        </a>
            ...
            <nav class="navbar navbar-secondary navbar-expand-lg">
                <div class="container">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('student.dashboard')); ?>" class="nav-link"><i
                                    class="fas fa-fire"></i><span><?php echo e(__lang('dashboard')); ?></span></a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><i
                                    class="fas fa-chalkboard-teacher"></i><span><?php echo e(setting('label_my_sessions', __lang('my-courses'))); ?></span></a>
                            <ul class="dropdown-menu dropdown-border">
                                <li class="nav-item"><a href="<?php echo e(route('student.student.mysessions')); ?>"
                                        class="nav-link"><?php echo e(__lang('enrolled-courses')); ?></a></li>
                        ...
                        <?php if(setting('menu_show_tests') == 1): ?>
                            <li class="nav-item dropdown">
                                <a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><i
                                        class="fas fa-check-circle"></i><span><?php echo e(setting('label_take_test', __lang('tests'))); ?></span></a>
                                <ul class="dropdown-menu dropdown-border">
                                    <li class="nav-item"><a href="<?php echo e(route('student.test.index')); ?>"
                                            class="nav-link"><?php echo e(__lang('browse-tests')); ?></a></li>
                                    <li class="nav-item"><a href="<?php echo e(route('student.test.statement')); ?>"
                                            class="nav-link"><?php echo e(__lang('statement-of-result')); ?></a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                    </ul>
...
<?php /**PATH C:\wamp64\www\lms\Resources\views/layouts/student.blade.php ENDPATH**/ ?>