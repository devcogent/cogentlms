                                  ...
                                  <div class="modal-body">
                                      <div>
                                          ...
                                          <video width="750" height="300" controls>
                                            <?php if($video->mime_type == 'video/mp4'): ?>
                                                <source src="<?php echo e(basePath()); ?>/uservideo/<?php echo e($video->id); ?>/<?php echo e($video->file_name); ?>" type="video/mp4">
                                            <?php endif; ?>
                                            <?php if($video->mime_type == 'video/ogg'): ?>
                                                <source src="<?php echo e(basePath()); ?>/uservideo/<?php echo e($video->id); ?>/<?php echo e($video->file_name); ?>" type="video/ogg">
                                            <?php endif; ?>
                                          </video>
                                          ...
                                          <?php $zoomData = @unserialize($row->content); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lms\Resources\views/admin/lecture/content.blade.php ENDPATH**/ ?>