                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group dropleft">
                                                    ...
                                                    <div class="dropdown-menu wide-btn">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(url('/admin/roles/' . $item->id)); ?>"><?php echo app('translator')->get('default.view'); ?></a>



                                                        <a class="dropdown-item"
                                                            href="<?php echo e(url('/admin/roles/' . $item->id . '/edit')); ?>"><?php echo app('translator')->get('default.edit'); ?></a>



                                                        <a class="dropdown-item" href="#"
                                                            onclick="$('#deleteForm<?php echo e($item->id); ?>').submit()"><?php echo app('translator')->get('default.delete'); ?></a>
                                                ...
                                                <form onsubmit="return confirm(&quot;<?php echo app('translator')->get('default.confirm-delete'); ?>&quot;)"
                                                    id="deleteForm<?php echo e($item->id); ?>" method="POST"
                                                    action="<?php echo e(url('/admin/roles' . '/' . $item->id)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lms\Resources\views/admin/roles/index.blade.php ENDPATH**/ ?>