...
<?php $__env->startSection('content'); ?>
    ...
    <?php 
            $hidePermisssiongroup  = array("settings", "certificates","discussions","resource");
            $hidePermission  = array("add_class_group", "edit_class_group","delete_class_group","view_class_groups","view_attendance_sheet","view_transactions",
            "view_payments","view_instructors","set_instructors","view_course_categories","add_course_category","edit_course_category","delete_course_category","export_student_attendance","message_students","view_forum_topics","add_forum_topic","view_forum_topic","reply_forum_topic","manage_class_downloads","manage_lecture_downloads");
    ?>
                                    ...
                                    <ul class="list-group">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <?php if($permission->name == 'view_students'): ?>
                                              <li class="list-group-item">  <?php echo e(__('View Trainee')); ?></li>
                                            <?php elseif($permission->name =='add_student'): ?>
                                              <li class="list-group-item">  <?php echo e(__('Add Trainee')); ?></li>
                                            <?php elseif($permission->name =='edit_student'): ?>
                                              <li class="list-group-item">   <?php echo e(__('Edit Trainee')); ?></li>
                                            <?php elseif($permission->name =='delete_student'): ?>
                                              <li class="list-group-item"><?php echo e(__('Delete Trainee')); ?></li>
                                            <?php elseif($permission->name =='view_student'): ?>
                                              <li class="list-group-item"> <?php echo e(__('View Trainees')); ?></li>
                                            <?php elseif($permission->name =='export_student'): ?>
                                              <li class="list-group-item"> <?php echo e(__('Export Trainees')); ?></li>
                                            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lms\Resources\views/admin/roles/show.blade.php ENDPATH**/ ?>