                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <?php if($item->name == 'Administrator'): ?>
                                           <?php continue; ?>
                                       <?php endif; ?>
                                    <tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\lms\Resources\views/admin/roles/index.blade.php ENDPATH**/ ?>