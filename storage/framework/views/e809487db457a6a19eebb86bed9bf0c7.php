			...
			<div >
				<div class="card">
					<div class="card-header">
                        <a class="btn btn-primary float-right" href="<?php echo e(adminUrl(array('controller'=>'student','action'=>'add'))); ?>"><i class="fa fa-plus"></i> <?php echo e(__('Add-Trainee')); ?></a>
                    </div>
					<div class="card-body">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('Trainee-Details')); ?></h5>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lms\Resources\views/admin/student/index.blade.php ENDPATH**/ ?>